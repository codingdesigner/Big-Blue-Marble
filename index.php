...
<html class='no-js' lang='en'>
  ...
  <head>
    <meta charset='utf-8' />
    <title>The Coding Designer's Survival Kit</title>
  ...
  <body>
    <div id='page'>
      <header>
        <h1>Big Blue Marble - website design</h1>
      </header>
      <div id='main' role='main'>
        <ol>
          <li><strong><a href="webroot">Design on prototype site</a></strong></li>
          <li><a href='/survivalkit'>styleguide</a></li>
        </ol>
      </div>
      <footer></footer>
    </div>
